...
export QUAIL_PROFILE_MODE=1
export QUAIL_ADAPTIVE_SAMPLING=1
...
#time g++ -I./third_party/include -c ./quail.cpp -std=c++14 -g -O0 -o /dev/null 
...
/usr/lib/gcc/x86_64-linux-gnu/5/cc1plus -quiet -imultiarch x86_64-linux-gnu -D_GNU_SOURCE quail.cpp -quiet -dumpbase quail.cpp -mtune=generic -march=x86-64 -auxbase-strip /dev/null -g -O0 -std=c++14 -I./third_party/include
#bin/qtest
#./readtest
